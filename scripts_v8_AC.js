...
function BankObject() {
    ...
    this.winGame = function() {
        $('#winLoseMsg').innerHTML = 'You win $' + bet.toString() + '!'; // not working at the moment
    ...
    this.drawGame = function() {
        $('#winLoseMsg').innerHTML = 'You Draw!'; // not working at the moment
    ...
    this.loseGame = function() {
        $('#winLoseMsg').innerHTML = 'You lose $' + bet.toString() + '!';  // not working at the moment
    ...
    this.gameOver = function() {
        if (cash === 0) {
            $('#winLoseMsg').innerHTML = 'You suck. I took all your money.'; // not working at the moment
