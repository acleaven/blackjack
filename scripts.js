...
function Deck(cardArray) {
    ...
    this.deal = function(e) {
        var randomIndex = Math.floor((Math.random() * 52); //this probably needs to be made a function that gets called repeatedly otherwise we'll be calling the same random number repeatedly.
