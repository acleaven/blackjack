...
function BankObject() {
    ...
    bet = 0; // sets initial bet amount at $0
    ...
    this.winGame = function() {
        $('#winLoseMsg').text('You win $' + bet.toString() + '!'); // changes the text of the winLoseMsg div to (...)
    ...
    this.drawGame = function() {
        $('#winLoseMsg').text('You Draw!'); // changes the text of the winLoseMsg div to (...)
    ...
    this.loseGame = function() {
        $('#winLoseMsg').text('You lose $' + bet.toString() + '!');  // changes the text of the winLoseMsg div to (...)
...
2. Need to program a Game Over function when player runs out of money.
3. We need directions for player div
4. card entrance animations (jQuery)
5. Change appearance of buttons
 */
